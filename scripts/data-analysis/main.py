...
def batch_plot(
    ...
    if summary:
        ...
        with open(csv_path, mode="w", newline="") as f:
            writer = csv.writer(f)
            writer.writerow(["Sample", "Crystallinity Ratio", "Group Std. Dev."])
